...
type ClientInterface interface {
	...
	ListRoleAssignments(ctx context.Context, tenant Tenant, params *ListRoleAssignmentsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteRoleAssignment request
	DeleteRoleAssignment(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleAssignmentParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetRoleAssignment request
	GetRoleAssignment(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateOrUpdateRoleAssignmentWithBody request with any body
	CreateOrUpdateRoleAssignmentWithBody(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateOrUpdateRoleAssignment(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, body CreateOrUpdateRoleAssignmentJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ListRoles request
	ListRoles(ctx context.Context, tenant Tenant, params *ListRolesParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteRole request
	DeleteRole(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetRole request
	GetRole(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateOrUpdateRoleWithBody request with any body
	CreateOrUpdateRoleWithBody(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateOrUpdateRole(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, body CreateOrUpdateRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) ListRoleAssignments(ctx context.Context, tenant Tenant, params *ListRoleAssignmentsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) DeleteRoleAssignment(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleAssignmentParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetRoleAssignment(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateOrUpdateRoleAssignmentWithBody(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateOrUpdateRoleAssignment(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, body CreateOrUpdateRoleAssignmentJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) ListRoles(ctx context.Context, tenant Tenant, params *ListRolesParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) DeleteRole(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetRole(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateOrUpdateRoleWithBody(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateOrUpdateRole(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, body CreateOrUpdateRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewListRoleAssignmentsRequest(server string, tenant Tenant, params *ListRoleAssignmentsParams) (*http.Request, error) {
	var err error
...
func NewDeleteRoleAssignmentRequest(server string, tenant Tenant, name ResourceName, params *DeleteRoleAssignmentParams) (*http.Request, error) {
	var err error
...
func NewGetRoleAssignmentRequest(server string, tenant Tenant, name ResourceName) (*http.Request, error) {
	var err error
...
func NewCreateOrUpdateRoleAssignmentRequest(server string, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, body CreateOrUpdateRoleAssignmentJSONRequestBody) (*http.Request, error) {
...
func NewCreateOrUpdateRoleAssignmentRequestWithBody(server string, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewListRolesRequest(server string, tenant Tenant, params *ListRolesParams) (*http.Request, error) {
	var err error
...
func NewDeleteRoleRequest(server string, tenant Tenant, name ResourceName, params *DeleteRoleParams) (*http.Request, error) {
	var err error
...
func NewGetRoleRequest(server string, tenant Tenant, name ResourceName) (*http.Request, error) {
	var err error
...
func NewCreateOrUpdateRoleRequest(server string, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, body CreateOrUpdateRoleJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewCreateOrUpdateRoleRequestWithBody(server string, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	ListRoleAssignmentsWithResponse(ctx context.Context, tenant Tenant, params *ListRoleAssignmentsParams, reqEditors ...RequestEditorFn) (*ListRoleAssignmentsResponse, error)

	// DeleteRoleAssignmentWithResponse request
	DeleteRoleAssignmentWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleAssignmentParams, reqEditors ...RequestEditorFn) (*DeleteRoleAssignmentResponse, error)

	// GetRoleAssignmentWithResponse request
	GetRoleAssignmentWithResponse(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*GetRoleAssignmentResponse, error)

	// CreateOrUpdateRoleAssignmentWithBodyWithResponse request with any body
	CreateOrUpdateRoleAssignmentWithBodyWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleAssignmentResponse, error)

	CreateOrUpdateRoleAssignmentWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, body CreateOrUpdateRoleAssignmentJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleAssignmentResponse, error)

	// ListRolesWithResponse request
	ListRolesWithResponse(ctx context.Context, tenant Tenant, params *ListRolesParams, reqEditors ...RequestEditorFn) (*ListRolesResponse, error)

	// DeleteRoleWithResponse request
	DeleteRoleWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleParams, reqEditors ...RequestEditorFn) (*DeleteRoleResponse, error)

	// GetRoleWithResponse request
	GetRoleWithResponse(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*GetRoleResponse, error)

	// CreateOrUpdateRoleWithBodyWithResponse request with any body
	CreateOrUpdateRoleWithBodyWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleResponse, error)

	CreateOrUpdateRoleWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, body CreateOrUpdateRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleResponse, error)
}
...
func (c *ClientWithResponses) ListRoleAssignmentsWithResponse(ctx context.Context, tenant Tenant, params *ListRoleAssignmentsParams, reqEditors ...RequestEditorFn) (*ListRoleAssignmentsResponse, error) {
...
func (c *ClientWithResponses) DeleteRoleAssignmentWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleAssignmentParams, reqEditors ...RequestEditorFn) (*DeleteRoleAssignmentResponse, error) {
...
func (c *ClientWithResponses) GetRoleAssignmentWithResponse(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*GetRoleAssignmentResponse, error) {
...
func (c *ClientWithResponses) CreateOrUpdateRoleAssignmentWithBodyWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleAssignmentResponse, error) {
...
func (c *ClientWithResponses) CreateOrUpdateRoleAssignmentWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleAssignmentParams, body CreateOrUpdateRoleAssignmentJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleAssignmentResponse, error) {
...
func (c *ClientWithResponses) ListRolesWithResponse(ctx context.Context, tenant Tenant, params *ListRolesParams, reqEditors ...RequestEditorFn) (*ListRolesResponse, error) {
...
func (c *ClientWithResponses) DeleteRoleWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *DeleteRoleParams, reqEditors ...RequestEditorFn) (*DeleteRoleResponse, error) {
...
func (c *ClientWithResponses) GetRoleWithResponse(ctx context.Context, tenant Tenant, name ResourceName, reqEditors ...RequestEditorFn) (*GetRoleResponse, error) {
...
func (c *ClientWithResponses) CreateOrUpdateRoleWithBodyWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleResponse, error) {
...
func (c *ClientWithResponses) CreateOrUpdateRoleWithResponse(ctx context.Context, tenant Tenant, name ResourceName, params *CreateOrUpdateRoleParams, body CreateOrUpdateRoleJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateOrUpdateRoleResponse, error) {
...
type ServerInterface interface {
	...
	ListRoleAssignments(w http.ResponseWriter, r *http.Request, tenant Tenant, params ListRoleAssignmentsParams)
	// Delete role assignment
	// (DELETE /v1/tenants/{tenant}/role-assignments/{name})
	DeleteRoleAssignment(w http.ResponseWriter, r *http.Request, tenant Tenant, name ResourceName, params DeleteRoleAssignmentParams)
	// Get role assignment
	// (GET /v1/tenants/{tenant}/role-assignments/{name})
	GetRoleAssignment(w http.ResponseWriter, r *http.Request, tenant Tenant, name ResourceName)
	// Create or update role assignment
	// (PUT /v1/tenants/{tenant}/role-assignments/{name})
	CreateOrUpdateRoleAssignment(w http.ResponseWriter, r *http.Request, tenant Tenant, name ResourceName, params CreateOrUpdateRoleAssignmentParams)
	// List roles
	// (GET /v1/tenants/{tenant}/roles)
	ListRoles(w http.ResponseWriter, r *http.Request, tenant Tenant, params ListRolesParams)
	// Delete role
	// (DELETE /v1/tenants/{tenant}/roles/{name})
	DeleteRole(w http.ResponseWriter, r *http.Request, tenant Tenant, name ResourceName, params DeleteRoleParams)
	// Get role
	// (GET /v1/tenants/{tenant}/roles/{name})
	GetRole(w http.ResponseWriter, r *http.Request, tenant Tenant, name ResourceName)
	// Create or update role
	// (PUT /v1/tenants/{tenant}/roles/{name})
	CreateOrUpdateRole(w http.ResponseWriter, r *http.Request, tenant Tenant, name ResourceName, params CreateOrUpdateRoleParams)
}
