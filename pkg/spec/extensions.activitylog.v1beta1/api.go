...
const (
	AcceptHeaderJson            ListActivityLogsParamsAccept = "application/json"
	AcceptHeaderJsonDeletedOnly ListActivityLogsParamsAccept = "application/json; deleted=only"
	AcceptHeaderJsonDeletedTrue ListActivityLogsParamsAccept = "application/json; deleted=true"
)

// ActivityLogIterator Iterator for activity logs
type ActivityLogIterator struct {
	// Items List of activity logs
	Items []externalRef0.ActivityLog `json:"items"`
...
type ClientInterface interface {
	...
	ListActivityLogs(ctx context.Context, tenant externalRef0.TenantPathParam, workspace externalRef0.WorkspacePathParam, params *ListActivityLogsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) ListActivityLogs(ctx context.Context, tenant externalRef0.TenantPathParam, workspace externalRef0.WorkspacePathParam, params *ListActivityLogsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewListActivityLogsRequest(server string, tenant externalRef0.TenantPathParam, workspace externalRef0.WorkspacePathParam, params *ListActivityLogsParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	ListActivityLogsWithResponse(ctx context.Context, tenant externalRef0.TenantPathParam, workspace externalRef0.WorkspacePathParam, params *ListActivityLogsParams, reqEditors ...RequestEditorFn) (*ListActivityLogsResponse, error)
}
...
func (c *ClientWithResponses) ListActivityLogsWithResponse(ctx context.Context, tenant externalRef0.TenantPathParam, workspace externalRef0.WorkspacePathParam, params *ListActivityLogsParams, reqEditors ...RequestEditorFn) (*ListActivityLogsResponse, error) {
...
type ServerInterface interface {
	...
	ListActivityLogs(w http.ResponseWriter, r *http.Request, tenant externalRef0.TenantPathParam, workspace externalRef0.WorkspacePathParam, params ListActivityLogsParams)
}
