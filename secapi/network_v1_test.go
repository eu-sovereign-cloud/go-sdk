...
func TestListNetworksV1(t *testing.T) {
	...
	secatest.MockListNetworksV1(sim, []schema.Network{
		*buildResponseNetwork(secatest.Network1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
	...
	assert.Equal(t, string(schema.ResourceStateActive), string(*resp[0].Status.State))
}
...
func TestListNetworksWithFiltersV1(t *testing.T) {
	...
	assert.Equal(t, string(schema.ResourceStateCreating), string(*resp[0].Status.State))
}
...
func TestGetNetworkV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseNetworkSpec(t, secatest.RouteTable1Ref)
	secatest.MockGetNetworkV1(sim, buildResponseNetwork(secatest.Network1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
	...
	assert.Equal(t, string(schema.ResourceStateActive), string(*resp.Status.State))
}
...
func TestGetNetworkUntilStateV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseNetworkSpec(t, secatest.RouteTable1Ref)
	secatest.MockGetNetworkV1(sim, buildResponseNetwork(secatest.Network1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetNetworkV1(sim, buildResponseNetwork(secatest.Network1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdateOrUpdateNetworkV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseNetworkSpec(t, secatest.RouteTable1Ref)
	secatest.MockCreateOrUpdateNetworkV1(sim, buildResponseNetwork(secatest.Network1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
	...
	assert.Equal(t, string(schema.ResourceStateCreating), string(*resp.Status.State))
}
...
func TestListSubnetsV1(t *testing.T) {
	...
	secatest.MockListSubnetsV1(sim, []schema.Subnet{
		*buildResponseSubnet(secatest.Subnet1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetSubnetV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSubnetSpec(t, secatest.NetworkSku1Ref)
	secatest.MockGetSubnetV1(sim, buildResponseSubnet(secatest.Subnet1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetSubnetUntilStateV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSubnetSpec(t, secatest.NetworkSku1Ref)
	secatest.MockGetSubnetV1(sim, buildResponseSubnet(secatest.Subnet1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetSubnetV1(sim, buildResponseSubnet(secatest.Subnet1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdateSubnetV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSubnetSpec(t, secatest.NetworkSku1Ref)
	secatest.MockCreateOrUpdateSubnetV1(sim, buildResponseSubnet(secatest.Subnet1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestListRouteTablesV1(t *testing.T) {
	...
	secatest.MockListRouteTablesV1(sim, []schema.RouteTable{
		*buildResponseRouteTable(secatest.RouteTable1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetRouteTableV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseRouteTableSpec(t, secatest.CidrIpv4, secatest.Instance1Ref)
	secatest.MockGetRouteTableV1(sim, buildResponseRouteTable(secatest.RouteTable1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetRouteTableUntilStateV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseRouteTableSpec(t, secatest.CidrIpv4, secatest.Instance1Ref)
	secatest.MockGetRouteTableV1(sim, buildResponseRouteTable(secatest.RouteTable1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetRouteTableV1(sim, buildResponseRouteTable(secatest.RouteTable1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdateRouteTableV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseRouteTableSpec(t, secatest.CidrIpv4, secatest.Instance1Ref)
	secatest.MockCreateOrUpdateRouteTableV1(sim, buildResponseRouteTable(secatest.RouteTable1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Network1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestListInternetGatewaysV1(t *testing.T) {
	...
	secatest.MockListInternetGatewaysV1(sim, []schema.InternetGateway{
		*buildResponseInternetGateway(secatest.InternetGateway1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetInternetGatewayV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseInternetGatewaySpec(false)
	secatest.MockGetInternetGatewayV1(sim, buildResponseInternetGateway(secatest.InternetGateway1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetInternetGatewayUntilStateV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseInternetGatewaySpec(false)
	secatest.MockGetInternetGatewayV1(sim, buildResponseInternetGateway(secatest.InternetGateway1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetInternetGatewayV1(sim, buildResponseInternetGateway(secatest.InternetGateway1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdateInternetGatewayV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseInternetGatewaySpec(false)
	secatest.MockCreateOrUpdateInternetGatewayV1(sim, buildResponseInternetGateway(secatest.InternetGateway1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestListSecurityGroupsV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSecurityGroupSpec(schema.SecurityGroupRuleDirectionIngress)
	secatest.MockListSecurityGroupsV1(sim, []schema.SecurityGroup{
		*buildResponseSecurityGroup(secatest.SecurityGroup1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetSecurityGroupV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSecurityGroupSpec(schema.SecurityGroupRuleDirectionIngress)
	secatest.MockGetSecurityGroupV1(sim, buildResponseSecurityGroup(secatest.SecurityGroup1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetSecurityGroupUntilStateV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSecurityGroupSpec(schema.SecurityGroupRuleDirectionIngress)
	secatest.MockGetSecurityGroupV1(sim, buildResponseSecurityGroup(secatest.SecurityGroup1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetSecurityGroupV1(sim, buildResponseSecurityGroup(secatest.SecurityGroup1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdateSecurityGroupV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseSecurityGroupSpec(schema.SecurityGroupRuleDirectionIngress)
	secatest.MockCreateOrUpdateSecurityGroupV1(sim, buildResponseSecurityGroup(secatest.SecurityGroup1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestListNicsV1(t *testing.T) {
	...
	secatest.MockListNicsV1(sim, []schema.Nic{
		*buildResponseNic(secatest.Nic1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetNicV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseNicSpec(t, secatest.Subnet1Ref)
	secatest.MockGetNicV1(sim, buildResponseNic(secatest.Nic1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdateNicV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponseNicSpec(t, secatest.Subnet1Ref)
	secatest.MockCreateOrUpdateNicV1(sim, buildResponseNic(secatest.Nic1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestListPublicIpsV1(t *testing.T) {
	...
	secatest.MockListPublicIpsV1(sim, []schema.PublicIp{
		*buildResponsePublicIp(secatest.PublicIp1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetPublicIpV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponsePublicIpSpec(secatest.Address1)
	secatest.MockGetPublicIpV1(sim, buildResponsePublicIp(secatest.PublicIp1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestGetPublicIpUntilStateV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponsePublicIpSpec(secatest.Address1)
	secatest.MockGetPublicIpV1(sim, buildResponsePublicIp(secatest.PublicIp1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetPublicIpV1(sim, buildResponsePublicIp(secatest.PublicIp1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureNetworkHandler(sim, sm)
...
func TestCreateOrUpdatePublicIpV1(t *testing.T) {
	...
	sim := mocknetwork.NewMockServerInterface(t)
	spec := buildResponsePublicIpSpec(secatest.Address1)
	secatest.MockCreateOrUpdatePublicIpV1(sim, buildResponsePublicIp(secatest.PublicIp1Name, secatest.Tenant1Name, secatest.Workspace1Name, secatest.Region1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureNetworkHandler(sim, sm)
