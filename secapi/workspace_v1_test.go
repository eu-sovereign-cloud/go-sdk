...
func TestListWorkspacesV1(t *testing.T) {
	...
	secatest.MockListWorkspaceV1(sim, []schema.Workspace{
		*buildResponseWorkspace(secatest.Workspace1Name, secatest.Tenant1Name, secatest.Region1Name, string(schema.ResourceStateActive)),
	})
...
func TestGetWorkspaceV1(t *testing.T) {
	...
	sim := mockworkspace.NewMockServerInterface(t)
	secatest.MockGetWorkspaceV1(sim, buildResponseWorkspace(secatest.Workspace1Name, secatest.Tenant1Name, secatest.Region1Name, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureWorkspaceHandler(sim, sm)
...
func TestGetWorkspaceUntilStateV1(t *testing.T) {
	...
	sim := mockworkspace.NewMockServerInterface(t)
	secatest.MockGetWorkspaceV1(sim, buildResponseWorkspace(secatest.Workspace1Name, secatest.Tenant1Name, secatest.Region1Name, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetWorkspaceV1(sim, buildResponseWorkspace(secatest.Workspace1Name, secatest.Tenant1Name, secatest.Region1Name, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureWorkspaceHandler(sim, sm)
...
func TestCreateOrUpdateWorkspaceV1(t *testing.T) {
	...
	sim := mockworkspace.NewMockServerInterface(t)
	secatest.MockCreateOrUpdateWorkspaceV1(sim, buildResponseWorkspace(secatest.Workspace1Name, secatest.Tenant1Name, secatest.Region1Name, string(schema.ResourceStateCreating)))
	secatest.ConfigureWorkspaceHandler(sim, sm)
