...
func TestListRolesV1(t *testing.T) {
	...
	secatest.MockListRolesV1(sim, []schema.Role{
		*buildResponseRole(secatest.Role1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateActive)),
	})
...
func TestGetRoleV1(t *testing.T) {
	...
	sim := mockauthorization.NewMockServerInterface(t)
	spec := buildResponseRoleSpec(secatest.Role1PermissionProvider, []string{secatest.Role1PermissionResource}, []string{secatest.Role1PermissionVerb})
	secatest.MockGetRoleV1(sim, buildResponseRole(secatest.Role1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureAuthorizationHandler(sim, sm)
...
func TestGetRoleUntilStateV1(t *testing.T) {
	...
	sim := mockauthorization.NewMockServerInterface(t)
	spec := buildResponseRoleSpec(secatest.Role1PermissionProvider, []string{secatest.Role1PermissionResource}, []string{secatest.Role1PermissionVerb})
	secatest.MockGetRoleV1(sim, buildResponseRole(secatest.Role1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetRoleV1(sim, buildResponseRole(secatest.Role1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureAuthorizationHandler(sim, sm)
...
func TestCreateOrUpdateRoleV1(t *testing.T) {
	...
	sim := mockauthorization.NewMockServerInterface(t)
	spec := buildResponseRoleSpec(secatest.Role1PermissionProvider, []string{secatest.Role1PermissionResource}, []string{secatest.Role1PermissionVerb})
	secatest.MockCreateOrUpdateRoleV1(sim, buildResponseRole(secatest.Role1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureAuthorizationHandler(sim, sm)
...
func TestListRoleAssignmentsV1(t *testing.T) {
	...
	secatest.MockListRoleAssignmentsV1(sim, []schema.RoleAssignment{
		*buildResponseRoleAssignment(secatest.RoleAssignment1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateActive)),
	})
	secatest.ConfigureAuthorizationHandler(sim, sm)
...
func TestGetRoleAssignmentV1(t *testing.T) {
	...
	sim := mockauthorization.NewMockServerInterface(t)
	spec := buildResponseRoleAssignmentSpec([]string{secatest.Role1Name}, []string{secatest.RoleAssignment1Subject})
	secatest.MockGetRoleAssignmentV1(sim, buildResponseRoleAssignment(secatest.RoleAssignment1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureAuthorizationHandler(sim, sm)
...
func TestGetRoleAssignmentUntilStateV1(t *testing.T) {
	...
	sim := mockauthorization.NewMockServerInterface(t)
	spec := buildResponseRoleAssignmentSpec([]string{secatest.Role1Name}, []string{secatest.RoleAssignment1Subject})
	secatest.MockGetRoleAssignmentV1(sim, buildResponseRoleAssignment(secatest.RoleAssignment1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateCreating)), 2)
	secatest.MockGetRoleAssignmentV1(sim, buildResponseRoleAssignment(secatest.RoleAssignment1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateActive)), 1)
	secatest.ConfigureAuthorizationHandler(sim, sm)
...
func TestCreateOrUpdateRoleAssignmentV1(t *testing.T) {
	...
	sim := mockauthorization.NewMockServerInterface(t)
	spec := buildResponseRoleAssignmentSpec([]string{secatest.Role1Name}, []string{secatest.RoleAssignment1Subject})
	secatest.MockCreateOrUpdateRoleAssignmentV1(sim, buildResponseRoleAssignment(secatest.RoleAssignment1Name, secatest.Tenant1Name, spec, string(schema.ResourceStateCreating)))
	secatest.ConfigureAuthorizationHandler(sim, sm)
