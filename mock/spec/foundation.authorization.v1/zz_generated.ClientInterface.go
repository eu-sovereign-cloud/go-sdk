...
func (_m *MockClientInterface) CreateOrUpdateRole(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleParams, body authorization.CreateOrUpdateRoleJSONRequestBody, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleParams, authorization.CreateOrUpdateRoleJSONRequestBody, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleParams, authorization.CreateOrUpdateRoleJSONRequestBody, ...authorization.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_CreateOrUpdateRole_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleParams, body authorization.CreateOrUpdateRoleJSONRequestBody, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_CreateOrUpdateRole_Call {
...
func (_c *MockClientInterface_CreateOrUpdateRole_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleParams, authorization.CreateOrUpdateRoleJSONRequestBody, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateRole_Call {
	_c.Call.Return(run)
	return _c
}

// CreateOrUpdateRoleAssignment provides a mock function with given fields: ctx, tenant, name, params, body, reqEditors
func (_m *MockClientInterface) CreateOrUpdateRoleAssignment(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleAssignmentParams, body authorization.CreateOrUpdateRoleAssignmentJSONRequestBody, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleAssignmentParams, authorization.CreateOrUpdateRoleAssignmentJSONRequestBody, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleAssignmentParams, authorization.CreateOrUpdateRoleAssignmentJSONRequestBody, ...authorization.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, name, params, body, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_CreateOrUpdateRoleAssignment_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleAssignmentParams, authorization.CreateOrUpdateRoleAssignmentJSONRequestBody, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateRoleAssignment_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientInterface) CreateOrUpdateRoleAssignmentWithBody(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleAssignmentParams, string, io.Reader, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleAssignmentParams, string, io.Reader, ...authorization.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_CreateOrUpdateRoleAssignmentWithBody_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleAssignmentParams, contentType string, body io.Reader, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_CreateOrUpdateRoleAssignmentWithBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_CreateOrUpdateRoleAssignmentWithBody_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleAssignmentParams, string, io.Reader, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateRoleAssignmentWithBody_Call {
	_c.Call.Return(run)
	return _c
}

// CreateOrUpdateRoleWithBody provides a mock function with given fields: ctx, tenant, name, params, contentType, body, reqEditors
func (_m *MockClientInterface) CreateOrUpdateRoleWithBody(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleParams, contentType string, body io.Reader, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleParams, string, io.Reader, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleParams, string, io.Reader, ...authorization.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, name, params, contentType, body, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_CreateOrUpdateRoleWithBody_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.CreateOrUpdateRoleParams, contentType string, body io.Reader, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_CreateOrUpdateRoleWithBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]authorization.RequestEditorFn, len(args)-6)
		for i, a := range args[6:] {
			if a != nil {
...
func (_c *MockClientInterface_CreateOrUpdateRoleWithBody_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.CreateOrUpdateRoleParams, string, io.Reader, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateRoleWithBody_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteRole provides a mock function with given fields: ctx, tenant, name, params, reqEditors
func (_m *MockClientInterface) DeleteRole(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.DeleteRoleParams, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.DeleteRoleParams, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.DeleteRoleParams, ...authorization.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_DeleteRole_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.DeleteRoleParams, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_DeleteRole_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_DeleteRole_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.DeleteRoleParams, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_DeleteRole_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteRoleAssignment provides a mock function with given fields: ctx, tenant, name, params, reqEditors
func (_m *MockClientInterface) DeleteRoleAssignment(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.DeleteRoleAssignmentParams, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.DeleteRoleAssignmentParams, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.DeleteRoleAssignmentParams, ...authorization.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, name, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_DeleteRoleAssignment_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, params *authorization.DeleteRoleAssignmentParams, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_DeleteRoleAssignment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]authorization.RequestEditorFn, len(args)-4)
		for i, a := range args[4:] {
			if a != nil {
...
func (_c *MockClientInterface_DeleteRoleAssignment_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, *authorization.DeleteRoleAssignmentParams, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_DeleteRoleAssignment_Call {
	_c.Call.Return(run)
	return _c
}

// GetRole provides a mock function with given fields: ctx, tenant, name, reqEditors
func (_m *MockClientInterface) GetRole(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, ...authorization.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_GetRole_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_GetRole_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_GetRole_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetRole_Call {
	_c.Call.Return(run)
	return _c
}

// GetRoleAssignment provides a mock function with given fields: ctx, tenant, name, reqEditors
func (_m *MockClientInterface) GetRoleAssignment(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
...
func (_c *MockClientInterface_GetRoleAssignment_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, name authorization.ResourcePathParam, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_GetRoleAssignment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]authorization.RequestEditorFn, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockClientInterface_GetRoleAssignment_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, authorization.ResourcePathParam, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetRoleAssignment_Call {
	_c.Call.Return(run)
	return _c
}

// ListRoleAssignments provides a mock function with given fields: ctx, tenant, params, reqEditors
func (_m *MockClientInterface) ListRoleAssignments(ctx context.Context, tenant authorization.TenantPathParam, params *authorization.ListRoleAssignmentsParams, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, *authorization.ListRoleAssignmentsParams, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, *authorization.ListRoleAssignmentsParams, ...authorization.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_ListRoleAssignments_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, params *authorization.ListRoleAssignmentsParams, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_ListRoleAssignments_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]authorization.RequestEditorFn, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockClientInterface_ListRoleAssignments_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, *authorization.ListRoleAssignmentsParams, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListRoleAssignments_Call {
	_c.Call.Return(run)
	return _c
}

// ListRoles provides a mock function with given fields: ctx, tenant, params, reqEditors
func (_m *MockClientInterface) ListRoles(ctx context.Context, tenant authorization.TenantPathParam, params *authorization.ListRolesParams, reqEditors ...authorization.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, *authorization.ListRolesParams, ...authorization.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authorization.TenantPathParam, *authorization.ListRolesParams, ...authorization.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_ListRoles_Call) Run(run func(ctx context.Context, tenant authorization.TenantPathParam, params *authorization.ListRolesParams, reqEditors ...authorization.RequestEditorFn)) *MockClientInterface_ListRoles_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]authorization.RequestEditorFn, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockClientInterface_ListRoles_Call) RunAndReturn(run func(context.Context, authorization.TenantPathParam, *authorization.ListRolesParams, ...authorization.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListRoles_Call {
	_c.Call.Return(run)
	return _c
}
