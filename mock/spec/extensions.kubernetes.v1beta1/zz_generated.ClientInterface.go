...
func (_m *MockClientInterface) CreateOrUpdateCluster(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateClusterParams, body kubernetes.CreateOrUpdateClusterJSONRequestBody, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, kubernetes.CreateOrUpdateClusterJSONRequestBody, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, kubernetes.CreateOrUpdateClusterJSONRequestBody, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, kubernetes.CreateOrUpdateClusterJSONRequestBody, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_CreateOrUpdateCluster_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateClusterParams, body kubernetes.CreateOrUpdateClusterJSONRequestBody, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_CreateOrUpdateCluster_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ResourcePathParam), args[4].(*kubernetes.CreateOrUpdateClusterParams), args[5].(kubernetes.CreateOrUpdateClusterJSONRequestBody), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_CreateOrUpdateCluster_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, kubernetes.CreateOrUpdateClusterJSONRequestBody, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateCluster_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientInterface) CreateOrUpdateClusterWithBody(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateClusterParams, contentType string, body io.Reader, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, string, io.Reader, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, string, io.Reader, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, string, io.Reader, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_CreateOrUpdateClusterWithBody_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateClusterParams, contentType string, body io.Reader, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_CreateOrUpdateClusterWithBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ResourcePathParam), args[4].(*kubernetes.CreateOrUpdateClusterParams), args[5].(string), args[6].(io.Reader), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_CreateOrUpdateClusterWithBody_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateClusterParams, string, io.Reader, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateClusterWithBody_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientInterface) CreateOrUpdateNodePool(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateNodePoolParams, body kubernetes.CreateOrUpdateNodePoolJSONRequestBody, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, kubernetes.CreateOrUpdateNodePoolJSONRequestBody, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, cluster, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, kubernetes.CreateOrUpdateNodePoolJSONRequestBody, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, kubernetes.CreateOrUpdateNodePoolJSONRequestBody, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_CreateOrUpdateNodePool_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateNodePoolParams, body kubernetes.CreateOrUpdateNodePoolJSONRequestBody, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_CreateOrUpdateNodePool_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ClusterPathParam), args[4].(schema.ResourcePathParam), args[5].(*kubernetes.CreateOrUpdateNodePoolParams), args[6].(kubernetes.CreateOrUpdateNodePoolJSONRequestBody), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_CreateOrUpdateNodePool_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, kubernetes.CreateOrUpdateNodePoolJSONRequestBody, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateNodePool_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientInterface) CreateOrUpdateNodePoolWithBody(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateNodePoolParams, contentType string, body io.Reader, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, string, io.Reader, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, cluster, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, string, io.Reader, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, string, io.Reader, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_CreateOrUpdateNodePoolWithBody_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, params *kubernetes.CreateOrUpdateNodePoolParams, contentType string, body io.Reader, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_CreateOrUpdateNodePoolWithBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ClusterPathParam), args[4].(schema.ResourcePathParam), args[5].(*kubernetes.CreateOrUpdateNodePoolParams), args[6].(string), args[7].(io.Reader), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_CreateOrUpdateNodePoolWithBody_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.CreateOrUpdateNodePoolParams, string, io.Reader, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateNodePoolWithBody_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteCluster provides a mock function with given fields: ctx, tenant, workspace, name, params, reqEditors
func (_m *MockClientInterface) DeleteCluster(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *kubernetes.DeleteClusterParams, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.DeleteClusterParams, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.DeleteClusterParams, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.DeleteClusterParams, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_DeleteCluster_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *kubernetes.DeleteClusterParams, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_DeleteCluster_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ResourcePathParam), args[4].(*kubernetes.DeleteClusterParams), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_DeleteCluster_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *kubernetes.DeleteClusterParams, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_DeleteCluster_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteNodePool provides a mock function with given fields: ctx, tenant, workspace, cluster, name, params, reqEditors
func (_m *MockClientInterface) DeleteNodePool(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, params *kubernetes.DeleteNodePoolParams, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.DeleteNodePoolParams, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, cluster, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.DeleteNodePoolParams, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.DeleteNodePoolParams, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_DeleteNodePool_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, params *kubernetes.DeleteNodePoolParams, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_DeleteNodePool_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ClusterPathParam), args[4].(schema.ResourcePathParam), args[5].(*kubernetes.DeleteNodePoolParams), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_DeleteNodePool_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, *kubernetes.DeleteNodePoolParams, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_DeleteNodePool_Call {
	_c.Call.Return(run)
	return _c
}

// GetCluster provides a mock function with given fields: ctx, tenant, workspace, name, reqEditors
func (_m *MockClientInterface) GetCluster(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_GetCluster_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_GetCluster_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_GetCluster_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetCluster_Call {
	_c.Call.Return(run)
	return _c
}

// GetNodePool provides a mock function with given fields: ctx, tenant, workspace, cluster, name, reqEditors
func (_m *MockClientInterface) GetNodePool(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, cluster, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_GetNodePool_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, name schema.ResourcePathParam, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_GetNodePool_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]kubernetes.RequestEditorFn, len(args)-5)
		for i, a := range args[5:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ClusterPathParam), args[4].(schema.ResourcePathParam), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_GetNodePool_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, schema.ResourcePathParam, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetNodePool_Call {
	_c.Call.Return(run)
	return _c
}

// ListClusters provides a mock function with given fields: ctx, tenant, workspace, params, reqEditors
func (_m *MockClientInterface) ListClusters(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *kubernetes.ListClustersParams, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *kubernetes.ListClustersParams, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *kubernetes.ListClustersParams, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *kubernetes.ListClustersParams, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_ListClusters_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *kubernetes.ListClustersParams, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_ListClusters_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]kubernetes.RequestEditorFn, len(args)-4)
		for i, a := range args[4:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(*kubernetes.ListClustersParams), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_ListClusters_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *kubernetes.ListClustersParams, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListClusters_Call {
	_c.Call.Return(run)
	return _c
}

// ListNodePools provides a mock function with given fields: ctx, tenant, workspace, cluster, params, reqEditors
func (_m *MockClientInterface) ListNodePools(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, params *kubernetes.ListNodePoolsParams, reqEditors ...kubernetes.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, *kubernetes.ListNodePoolsParams, ...kubernetes.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, cluster, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, *kubernetes.ListNodePoolsParams, ...kubernetes.RequestEditorFn) *http.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, *kubernetes.ListNodePoolsParams, ...kubernetes.RequestEditorFn) error); ok {
...
func (_c *MockClientInterface_ListNodePools_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, cluster schema.ClusterPathParam, params *kubernetes.ListNodePoolsParams, reqEditors ...kubernetes.RequestEditorFn)) *MockClientInterface_ListNodePools_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]kubernetes.RequestEditorFn, len(args)-5)
		for i, a := range args[5:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(schema.TenantPathParam), args[2].(schema.WorkspacePathParam), args[3].(schema.ClusterPathParam), args[4].(*kubernetes.ListNodePoolsParams), variadicArgs...)
	})
	return _c
}
...
func (_c *MockClientInterface_ListNodePools_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ClusterPathParam, *kubernetes.ListNodePoolsParams, ...kubernetes.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListNodePools_Call {
	_c.Call.Return(run)
	return _c
}
