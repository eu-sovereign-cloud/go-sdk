...
func (_m *MockClientWithResponsesInterface) CreateOrUpdateAccountWithBodyWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *objectstorage.CreateOrUpdateAccountParams, contentType string, body io.Reader, reqEditors ...objectstorage.RequestEditorFn) (*objectstorage.CreateOrUpdateAccountResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.CreateOrUpdateAccountParams, string, io.Reader, ...objectstorage.RequestEditorFn) (*objectstorage.CreateOrUpdateAccountResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.CreateOrUpdateAccountParams, string, io.Reader, ...objectstorage.RequestEditorFn) *objectstorage.CreateOrUpdateAccountResponse); ok {
...
func (_m *MockClientWithResponsesInterface) CreateOrUpdateAccountWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *objectstorage.CreateOrUpdateAccountParams, body objectstorage.CreateOrUpdateAccountJSONRequestBody, reqEditors ...objectstorage.RequestEditorFn) (*objectstorage.CreateOrUpdateAccountResponse, error) {
	...
	var r0 *objectstorage.CreateOrUpdateAccountResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.CreateOrUpdateAccountParams, objectstorage.CreateOrUpdateAccountJSONRequestBody, ...objectstorage.RequestEditorFn) (*objectstorage.CreateOrUpdateAccountResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.CreateOrUpdateAccountParams, objectstorage.CreateOrUpdateAccountJSONRequestBody, ...objectstorage.RequestEditorFn) *objectstorage.CreateOrUpdateAccountResponse); ok {
...
func (_c *MockClientWithResponsesInterface_CreateOrUpdateAccountWithResponse_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *objectstorage.CreateOrUpdateAccountParams, body objectstorage.CreateOrUpdateAccountJSONRequestBody, reqEditors ...objectstorage.RequestEditorFn)) *MockClientWithResponsesInterface_CreateOrUpdateAccountWithResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *MockClientWithResponsesInterface) DeleteAccountWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *objectstorage.DeleteAccountParams, reqEditors ...objectstorage.RequestEditorFn) (*objectstorage.DeleteAccountResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.DeleteAccountParams, ...objectstorage.RequestEditorFn) (*objectstorage.DeleteAccountResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.DeleteAccountParams, ...objectstorage.RequestEditorFn) *objectstorage.DeleteAccountResponse); ok {
...
func (_c *MockClientWithResponsesInterface_DeleteAccountWithResponse_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *objectstorage.DeleteAccountParams, ...objectstorage.RequestEditorFn) (*objectstorage.DeleteAccountResponse, error)) *MockClientWithResponsesInterface_DeleteAccountWithResponse_Call {
	_c.Call.Return(run)
	return _c
}

// GetAccountWithResponse provides a mock function with given fields: ctx, tenant, workspace, name, reqEditors
func (_m *MockClientWithResponsesInterface) GetAccountWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...objectstorage.RequestEditorFn) (*objectstorage.GetAccountResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...objectstorage.RequestEditorFn) (*objectstorage.GetAccountResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...objectstorage.RequestEditorFn) *objectstorage.GetAccountResponse); ok {
...
func (_c *MockClientWithResponsesInterface_GetAccountWithResponse_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...objectstorage.RequestEditorFn)) *MockClientWithResponsesInterface_GetAccountWithResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientWithResponsesInterface_GetAccountWithResponse_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...objectstorage.RequestEditorFn) (*objectstorage.GetAccountResponse, error)) *MockClientWithResponsesInterface_GetAccountWithResponse_Call {
	_c.Call.Return(run)
	return _c
}

// ListAccountsWithResponse provides a mock function with given fields: ctx, tenant, workspace, params, reqEditors
func (_m *MockClientWithResponsesInterface) ListAccountsWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *objectstorage.ListAccountsParams, reqEditors ...objectstorage.RequestEditorFn) (*objectstorage.ListAccountsResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *objectstorage.ListAccountsParams, ...objectstorage.RequestEditorFn) (*objectstorage.ListAccountsResponse, error)); ok {
		return rf(ctx, tenant, workspace, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *objectstorage.ListAccountsParams, ...objectstorage.RequestEditorFn) *objectstorage.ListAccountsResponse); ok {
