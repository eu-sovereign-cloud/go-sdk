...
func (_m *MockServerInterface) CreateOrUpdateNetworkLoadBalancer(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params loadbalancer.CreateOrUpdateNetworkLoadBalancerParams) {
...
func (_c *MockServerInterface_CreateOrUpdateNetworkLoadBalancer_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params loadbalancer.CreateOrUpdateNetworkLoadBalancerParams)) *MockServerInterface_CreateOrUpdateNetworkLoadBalancer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(loadbalancer.CreateOrUpdateNetworkLoadBalancerParams))
	})
	return _c
}
...
func (_c *MockServerInterface_CreateOrUpdateNetworkLoadBalancer_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, loadbalancer.CreateOrUpdateNetworkLoadBalancerParams)) *MockServerInterface_CreateOrUpdateNetworkLoadBalancer_Call {
	_c.Run(run)
	return _c
}

// DeleteNetworkLoadBalancer provides a mock function with given fields: w, r, tenant, workspace, name, params
func (_m *MockServerInterface) DeleteNetworkLoadBalancer(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params loadbalancer.DeleteNetworkLoadBalancerParams) {
	_m.Called(w, r, tenant, workspace, name, params)
}
...
func (_c *MockServerInterface_DeleteNetworkLoadBalancer_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params loadbalancer.DeleteNetworkLoadBalancerParams)) *MockServerInterface_DeleteNetworkLoadBalancer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(loadbalancer.DeleteNetworkLoadBalancerParams))
	})
	return _c
}
...
func (_c *MockServerInterface_DeleteNetworkLoadBalancer_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, loadbalancer.DeleteNetworkLoadBalancerParams)) *MockServerInterface_DeleteNetworkLoadBalancer_Call {
	_c.Run(run)
	return _c
}

// GetNetworkLoadBalancer provides a mock function with given fields: w, r, tenant, workspace, name
func (_m *MockServerInterface) GetNetworkLoadBalancer(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam) {
...
func (_c *MockServerInterface_GetNetworkLoadBalancer_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam)) *MockServerInterface_GetNetworkLoadBalancer_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServerInterface_GetNetworkLoadBalancer_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam)) *MockServerInterface_GetNetworkLoadBalancer_Call {
	_c.Run(run)
	return _c
}

// ListNetworkLoadBalancers provides a mock function with given fields: w, r, tenant, workspace, params
func (_m *MockServerInterface) ListNetworkLoadBalancers(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params loadbalancer.ListNetworkLoadBalancersParams) {
...
func (_c *MockServerInterface_ListNetworkLoadBalancers_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params loadbalancer.ListNetworkLoadBalancersParams)) *MockServerInterface_ListNetworkLoadBalancers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(loadbalancer.ListNetworkLoadBalancersParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListNetworkLoadBalancers_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, loadbalancer.ListNetworkLoadBalancersParams)) *MockServerInterface_ListNetworkLoadBalancers_Call {
	_c.Run(run)
	return _c
}
