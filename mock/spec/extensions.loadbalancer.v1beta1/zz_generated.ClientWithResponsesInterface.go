...
func (_m *MockClientWithResponsesInterface) CreateOrUpdateNetworkLoadBalancerWithBodyWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, contentType string, body io.Reader, reqEditors ...loadbalancer.RequestEditorFn) (*loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, string, io.Reader, ...loadbalancer.RequestEditorFn) (*loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, string, io.Reader, ...loadbalancer.RequestEditorFn) *loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse); ok {
...
func (_c *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithBodyWithResponse_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, contentType string, body io.Reader, reqEditors ...loadbalancer.RequestEditorFn)) *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithBodyWithResponse_Call {
...
func (_c *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithBodyWithResponse_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, string, io.Reader, ...loadbalancer.RequestEditorFn) (*loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse, error)) *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithBodyWithResponse_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientWithResponsesInterface) CreateOrUpdateNetworkLoadBalancerWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, body loadbalancer.CreateOrUpdateNetworkLoadBalancerJSONRequestBody, reqEditors ...loadbalancer.RequestEditorFn) (*loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, loadbalancer.CreateOrUpdateNetworkLoadBalancerJSONRequestBody, ...loadbalancer.RequestEditorFn) (*loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, loadbalancer.CreateOrUpdateNetworkLoadBalancerJSONRequestBody, ...loadbalancer.RequestEditorFn) *loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse); ok {
...
func (_c *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithResponse_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, body loadbalancer.CreateOrUpdateNetworkLoadBalancerJSONRequestBody, reqEditors ...loadbalancer.RequestEditorFn)) *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithResponse_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.CreateOrUpdateNetworkLoadBalancerParams, loadbalancer.CreateOrUpdateNetworkLoadBalancerJSONRequestBody, ...loadbalancer.RequestEditorFn) (*loadbalancer.CreateOrUpdateNetworkLoadBalancerResponse, error)) *MockClientWithResponsesInterface_CreateOrUpdateNetworkLoadBalancerWithResponse_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientWithResponsesInterface) DeleteNetworkLoadBalancerWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *loadbalancer.DeleteNetworkLoadBalancerParams, reqEditors ...loadbalancer.RequestEditorFn) (*loadbalancer.DeleteNetworkLoadBalancerResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.DeleteNetworkLoadBalancerParams, ...loadbalancer.RequestEditorFn) (*loadbalancer.DeleteNetworkLoadBalancerResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.DeleteNetworkLoadBalancerParams, ...loadbalancer.RequestEditorFn) *loadbalancer.DeleteNetworkLoadBalancerResponse); ok {
...
func (_c *MockClientWithResponsesInterface_DeleteNetworkLoadBalancerWithResponse_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *loadbalancer.DeleteNetworkLoadBalancerParams, ...loadbalancer.RequestEditorFn) (*loadbalancer.DeleteNetworkLoadBalancerResponse, error)) *MockClientWithResponsesInterface_DeleteNetworkLoadBalancerWithResponse_Call {
	_c.Call.Return(run)
	return _c
}

// GetNetworkLoadBalancerWithResponse provides a mock function with given fields: ctx, tenant, workspace, name, reqEditors
func (_m *MockClientWithResponsesInterface) GetNetworkLoadBalancerWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...loadbalancer.RequestEditorFn) (*loadbalancer.GetNetworkLoadBalancerResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...loadbalancer.RequestEditorFn) (*loadbalancer.GetNetworkLoadBalancerResponse, error)); ok {
		return rf(ctx, tenant, workspace, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...loadbalancer.RequestEditorFn) *loadbalancer.GetNetworkLoadBalancerResponse); ok {
...
func (_c *MockClientWithResponsesInterface_GetNetworkLoadBalancerWithResponse_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...loadbalancer.RequestEditorFn)) *MockClientWithResponsesInterface_GetNetworkLoadBalancerWithResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *MockClientWithResponsesInterface) ListNetworkLoadBalancersWithResponse(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *loadbalancer.ListNetworkLoadBalancersParams, reqEditors ...loadbalancer.RequestEditorFn) (*loadbalancer.ListNetworkLoadBalancersResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *loadbalancer.ListNetworkLoadBalancersParams, ...loadbalancer.RequestEditorFn) (*loadbalancer.ListNetworkLoadBalancersResponse, error)); ok {
		return rf(ctx, tenant, workspace, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *loadbalancer.ListNetworkLoadBalancersParams, ...loadbalancer.RequestEditorFn) *loadbalancer.ListNetworkLoadBalancersResponse); ok {
...
func (_c *MockClientWithResponsesInterface_ListNetworkLoadBalancersWithResponse_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *loadbalancer.ListNetworkLoadBalancersParams, reqEditors ...loadbalancer.RequestEditorFn)) *MockClientWithResponsesInterface_ListNetworkLoadBalancersWithResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]loadbalancer.RequestEditorFn, len(args)-4)
		for i, a := range args[4:] {
			if a != nil {
...
func (_c *MockClientWithResponsesInterface_ListNetworkLoadBalancersWithResponse_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *loadbalancer.ListNetworkLoadBalancersParams, ...loadbalancer.RequestEditorFn) (*loadbalancer.ListNetworkLoadBalancersResponse, error)) *MockClientWithResponsesInterface_ListNetworkLoadBalancersWithResponse_Call {
	_c.Call.Return(run)
	return _c
}
