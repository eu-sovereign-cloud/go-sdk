...
func (_m *MockServerInterface) CreateOrUpdateWorkspace(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, name workspace.ResourcePathParam, params workspace.CreateOrUpdateWorkspaceParams) {
...
func (_c *MockServerInterface_CreateOrUpdateWorkspace_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, name workspace.ResourcePathParam, params workspace.CreateOrUpdateWorkspaceParams)) *MockServerInterface_CreateOrUpdateWorkspace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(workspace.TenantPathParam), args[3].(workspace.ResourcePathParam), args[4].(workspace.CreateOrUpdateWorkspaceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_CreateOrUpdateWorkspace_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, workspace.TenantPathParam, workspace.ResourcePathParam, workspace.CreateOrUpdateWorkspaceParams)) *MockServerInterface_CreateOrUpdateWorkspace_Call {
	_c.Run(run)
	return _c
}

// DeleteWorkspace provides a mock function with given fields: w, r, tenant, name, params
func (_m *MockServerInterface) DeleteWorkspace(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, name workspace.ResourcePathParam, params workspace.DeleteWorkspaceParams) {
	_m.Called(w, r, tenant, name, params)
}
...
func (_c *MockServerInterface_DeleteWorkspace_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, name workspace.ResourcePathParam, params workspace.DeleteWorkspaceParams)) *MockServerInterface_DeleteWorkspace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(workspace.TenantPathParam), args[3].(workspace.ResourcePathParam), args[4].(workspace.DeleteWorkspaceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_DeleteWorkspace_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, workspace.TenantPathParam, workspace.ResourcePathParam, workspace.DeleteWorkspaceParams)) *MockServerInterface_DeleteWorkspace_Call {
	_c.Run(run)
	return _c
}

// GetWorkspace provides a mock function with given fields: w, r, tenant, name
func (_m *MockServerInterface) GetWorkspace(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, name workspace.ResourcePathParam) {
...
func (_c *MockServerInterface_GetWorkspace_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, name workspace.ResourcePathParam)) *MockServerInterface_GetWorkspace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(workspace.TenantPathParam), args[3].(workspace.ResourcePathParam))
	})
	return _c
}
...
func (_c *MockServerInterface_GetWorkspace_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, workspace.TenantPathParam, workspace.ResourcePathParam)) *MockServerInterface_GetWorkspace_Call {
	_c.Run(run)
	return _c
}

// ListWorkspaces provides a mock function with given fields: w, r, tenant, params
func (_m *MockServerInterface) ListWorkspaces(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, params workspace.ListWorkspacesParams) {
...
func (_c *MockServerInterface_ListWorkspaces_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant workspace.TenantPathParam, params workspace.ListWorkspacesParams)) *MockServerInterface_ListWorkspaces_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(workspace.TenantPathParam), args[3].(workspace.ListWorkspacesParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListWorkspaces_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, workspace.TenantPathParam, workspace.ListWorkspacesParams)) *MockServerInterface_ListWorkspaces_Call {
	_c.Run(run)
	return _c
}
