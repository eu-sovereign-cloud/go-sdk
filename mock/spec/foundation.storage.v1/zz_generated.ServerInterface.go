...
func (_m *MockServerInterface) CreateOrUpdateBlockStorage(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params storage.CreateOrUpdateBlockStorageParams) {
...
func (_c *MockServerInterface_CreateOrUpdateBlockStorage_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params storage.CreateOrUpdateBlockStorageParams)) *MockServerInterface_CreateOrUpdateBlockStorage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(storage.CreateOrUpdateBlockStorageParams))
	})
	return _c
}
...
func (_c *MockServerInterface_CreateOrUpdateBlockStorage_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, storage.CreateOrUpdateBlockStorageParams)) *MockServerInterface_CreateOrUpdateBlockStorage_Call {
	_c.Run(run)
	return _c
}

// CreateOrUpdateImage provides a mock function with given fields: w, r, tenant, name, params
func (_m *MockServerInterface) CreateOrUpdateImage(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, name schema.ResourcePathParam, params storage.CreateOrUpdateImageParams) {
...
func (_c *MockServerInterface_CreateOrUpdateImage_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, name schema.ResourcePathParam, params storage.CreateOrUpdateImageParams)) *MockServerInterface_CreateOrUpdateImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.ResourcePathParam), args[4].(storage.CreateOrUpdateImageParams))
	})
	return _c
}
...
func (_c *MockServerInterface_CreateOrUpdateImage_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.ResourcePathParam, storage.CreateOrUpdateImageParams)) *MockServerInterface_CreateOrUpdateImage_Call {
	_c.Run(run)
	return _c
}

// DeleteBlockStorage provides a mock function with given fields: w, r, tenant, workspace, name, params
func (_m *MockServerInterface) DeleteBlockStorage(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params storage.DeleteBlockStorageParams) {
	_m.Called(w, r, tenant, workspace, name, params)
}
...
func (_c *MockServerInterface_DeleteBlockStorage_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params storage.DeleteBlockStorageParams)) *MockServerInterface_DeleteBlockStorage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(storage.DeleteBlockStorageParams))
	})
	return _c
}
...
func (_c *MockServerInterface_DeleteBlockStorage_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, storage.DeleteBlockStorageParams)) *MockServerInterface_DeleteBlockStorage_Call {
	_c.Run(run)
	return _c
}

// DeleteImage provides a mock function with given fields: w, r, tenant, name, params
func (_m *MockServerInterface) DeleteImage(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, name schema.ResourcePathParam, params storage.DeleteImageParams) {
	_m.Called(w, r, tenant, name, params)
}
...
func (_c *MockServerInterface_DeleteImage_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, name schema.ResourcePathParam, params storage.DeleteImageParams)) *MockServerInterface_DeleteImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.ResourcePathParam), args[4].(storage.DeleteImageParams))
	})
	return _c
}
...
func (_c *MockServerInterface_DeleteImage_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.ResourcePathParam, storage.DeleteImageParams)) *MockServerInterface_DeleteImage_Call {
	_c.Run(run)
	return _c
}

// GetBlockStorage provides a mock function with given fields: w, r, tenant, workspace, name
func (_m *MockServerInterface) GetBlockStorage(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam) {
...
func (_c *MockServerInterface_GetBlockStorage_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam)) *MockServerInterface_GetBlockStorage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServerInterface_GetBlockStorage_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam)) *MockServerInterface_GetBlockStorage_Call {
	_c.Run(run)
	return _c
}

// GetImage provides a mock function with given fields: w, r, tenant, name
func (_m *MockServerInterface) GetImage(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, name schema.ResourcePathParam) {
...
func (_c *MockServerInterface_GetImage_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, name schema.ResourcePathParam)) *MockServerInterface_GetImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServerInterface_GetImage_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.ResourcePathParam)) *MockServerInterface_GetImage_Call {
	_c.Run(run)
	return _c
}
...
func (_m *MockServerInterface) ListBlockStorages(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params storage.ListBlockStoragesParams) {
...
func (_c *MockServerInterface_ListBlockStorages_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params storage.ListBlockStoragesParams)) *MockServerInterface_ListBlockStorages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(storage.ListBlockStoragesParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListBlockStorages_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, storage.ListBlockStoragesParams)) *MockServerInterface_ListBlockStorages_Call {
	_c.Run(run)
	return _c
}

// ListImages provides a mock function with given fields: w, r, tenant, params
func (_m *MockServerInterface) ListImages(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, params storage.ListImagesParams) {
...
func (_c *MockServerInterface_ListImages_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, params storage.ListImagesParams)) *MockServerInterface_ListImages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(storage.ListImagesParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListImages_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, storage.ListImagesParams)) *MockServerInterface_ListImages_Call {
	_c.Run(run)
	return _c
}

// ListSkus provides a mock function with given fields: w, r, tenant, params
func (_m *MockServerInterface) ListSkus(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, params storage.ListSkusParams) {
	_m.Called(w, r, tenant, params)
}
...
func (_c *MockServerInterface_ListSkus_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, params storage.ListSkusParams)) *MockServerInterface_ListSkus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(storage.ListSkusParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListSkus_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, storage.ListSkusParams)) *MockServerInterface_ListSkus_Call {
	_c.Run(run)
	return _c
}
