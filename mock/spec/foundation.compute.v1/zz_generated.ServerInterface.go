...
func (_m *MockServerInterface) CreateOrUpdateInstance(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.CreateOrUpdateInstanceParams) {
...
func (_c *MockServerInterface_CreateOrUpdateInstance_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.CreateOrUpdateInstanceParams)) *MockServerInterface_CreateOrUpdateInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(compute.CreateOrUpdateInstanceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_CreateOrUpdateInstance_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, compute.CreateOrUpdateInstanceParams)) *MockServerInterface_CreateOrUpdateInstance_Call {
	_c.Run(run)
	return _c
}

// DeleteInstance provides a mock function with given fields: w, r, tenant, workspace, name, params
func (_m *MockServerInterface) DeleteInstance(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.DeleteInstanceParams) {
	_m.Called(w, r, tenant, workspace, name, params)
}
...
func (_c *MockServerInterface_DeleteInstance_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.DeleteInstanceParams)) *MockServerInterface_DeleteInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(compute.DeleteInstanceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_DeleteInstance_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, compute.DeleteInstanceParams)) *MockServerInterface_DeleteInstance_Call {
	_c.Run(run)
	return _c
}

// GetInstance provides a mock function with given fields: w, r, tenant, workspace, name
func (_m *MockServerInterface) GetInstance(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam) {
...
func (_c *MockServerInterface_GetInstance_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam)) *MockServerInterface_GetInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServerInterface_GetInstance_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam)) *MockServerInterface_GetInstance_Call {
	_c.Run(run)
	return _c
}
...
func (_m *MockServerInterface) ListInstances(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params compute.ListInstancesParams) {
...
func (_c *MockServerInterface_ListInstances_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params compute.ListInstancesParams)) *MockServerInterface_ListInstances_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(compute.ListInstancesParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListInstances_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, compute.ListInstancesParams)) *MockServerInterface_ListInstances_Call {
	_c.Run(run)
	return _c
}

// ListSkus provides a mock function with given fields: w, r, tenant, params
func (_m *MockServerInterface) ListSkus(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, params compute.ListSkusParams) {
...
func (_c *MockServerInterface_ListSkus_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, params compute.ListSkusParams)) *MockServerInterface_ListSkus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(compute.ListSkusParams))
	})
	return _c
}
...
func (_c *MockServerInterface_ListSkus_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, compute.ListSkusParams)) *MockServerInterface_ListSkus_Call {
	_c.Run(run)
	return _c
}

// RestartInstance provides a mock function with given fields: w, r, tenant, workspace, name, params
func (_m *MockServerInterface) RestartInstance(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.RestartInstanceParams) {
	_m.Called(w, r, tenant, workspace, name, params)
}
...
func (_c *MockServerInterface_RestartInstance_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.RestartInstanceParams)) *MockServerInterface_RestartInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(compute.RestartInstanceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_RestartInstance_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, compute.RestartInstanceParams)) *MockServerInterface_RestartInstance_Call {
	_c.Run(run)
	return _c
}

// StartInstance provides a mock function with given fields: w, r, tenant, workspace, name, params
func (_m *MockServerInterface) StartInstance(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.StartInstanceParams) {
	_m.Called(w, r, tenant, workspace, name, params)
}
...
func (_c *MockServerInterface_StartInstance_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.StartInstanceParams)) *MockServerInterface_StartInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(compute.StartInstanceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_StartInstance_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, compute.StartInstanceParams)) *MockServerInterface_StartInstance_Call {
	_c.Run(run)
	return _c
}

// StopInstance provides a mock function with given fields: w, r, tenant, workspace, name, params
func (_m *MockServerInterface) StopInstance(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.StopInstanceParams) {
	_m.Called(w, r, tenant, workspace, name, params)
}
...
func (_c *MockServerInterface_StopInstance_Call) Run(run func(w http.ResponseWriter, r *http.Request, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params compute.StopInstanceParams)) *MockServerInterface_StopInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.TenantPathParam), args[3].(schema.WorkspacePathParam), args[4].(schema.ResourcePathParam), args[5].(compute.StopInstanceParams))
	})
	return _c
}
...
func (_c *MockServerInterface_StopInstance_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, compute.StopInstanceParams)) *MockServerInterface_StopInstance_Call {
	_c.Run(run)
	return _c
}
