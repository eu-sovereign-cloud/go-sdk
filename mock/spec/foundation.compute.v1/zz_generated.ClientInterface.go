...
func (_m *MockClientInterface) CreateOrUpdateInstance(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.CreateOrUpdateInstanceParams, body compute.CreateOrUpdateInstanceJSONRequestBody, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.CreateOrUpdateInstanceParams, compute.CreateOrUpdateInstanceJSONRequestBody, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.CreateOrUpdateInstanceParams, compute.CreateOrUpdateInstanceJSONRequestBody, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_CreateOrUpdateInstance_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.CreateOrUpdateInstanceParams, compute.CreateOrUpdateInstanceJSONRequestBody, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateInstance_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClientInterface) CreateOrUpdateInstanceWithBody(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.CreateOrUpdateInstanceParams, contentType string, body io.Reader, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.CreateOrUpdateInstanceParams, string, io.Reader, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, contentType, body, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.CreateOrUpdateInstanceParams, string, io.Reader, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_CreateOrUpdateInstanceWithBody_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.CreateOrUpdateInstanceParams, contentType string, body io.Reader, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_CreateOrUpdateInstanceWithBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_CreateOrUpdateInstanceWithBody_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.CreateOrUpdateInstanceParams, string, io.Reader, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_CreateOrUpdateInstanceWithBody_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteInstance provides a mock function with given fields: ctx, tenant, workspace, name, params, reqEditors
func (_m *MockClientInterface) DeleteInstance(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.DeleteInstanceParams, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.DeleteInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.DeleteInstanceParams, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_DeleteInstance_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.DeleteInstanceParams, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_DeleteInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_DeleteInstance_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.DeleteInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_DeleteInstance_Call {
	_c.Call.Return(run)
	return _c
}

// GetInstance provides a mock function with given fields: ctx, tenant, workspace, name, reqEditors
func (_m *MockClientInterface) GetInstance(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_GetInstance_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_GetInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_GetInstance_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetInstance_Call {
	_c.Call.Return(run)
	return _c
}

// GetSku provides a mock function with given fields: ctx, tenant, name, reqEditors
func (_m *MockClientInterface) GetSku(ctx context.Context, tenant schema.TenantPathParam, name schema.ResourcePathParam, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.ResourcePathParam, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.ResourcePathParam, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_GetSku_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, name schema.ResourcePathParam, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_GetSku_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_GetSku_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.ResourcePathParam, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetSku_Call {
	_c.Call.Return(run)
	return _c
}

// ListInstances provides a mock function with given fields: ctx, tenant, workspace, params, reqEditors
func (_m *MockClientInterface) ListInstances(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *compute.ListInstancesParams, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *compute.ListInstancesParams, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *compute.ListInstancesParams, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_ListInstances_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *compute.ListInstancesParams, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_ListInstances_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]compute.RequestEditorFn, len(args)-4)
		for i, a := range args[4:] {
			if a != nil {
...
func (_c *MockClientInterface_ListInstances_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *compute.ListInstancesParams, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListInstances_Call {
	_c.Call.Return(run)
	return _c
}

// ListSkus provides a mock function with given fields: ctx, tenant, params, reqEditors
func (_m *MockClientInterface) ListSkus(ctx context.Context, tenant schema.TenantPathParam, params *compute.ListSkusParams, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, *compute.ListSkusParams, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, *compute.ListSkusParams, ...compute.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_ListSkus_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, params *compute.ListSkusParams, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_ListSkus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]compute.RequestEditorFn, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockClientInterface_ListSkus_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, *compute.ListSkusParams, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListSkus_Call {
	_c.Call.Return(run)
	return _c
}

// RestartInstance provides a mock function with given fields: ctx, tenant, workspace, name, params, reqEditors
func (_m *MockClientInterface) RestartInstance(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.RestartInstanceParams, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.RestartInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.RestartInstanceParams, ...compute.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, workspace, name, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_RestartInstance_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.RestartInstanceParams, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_RestartInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]compute.RequestEditorFn, len(args)-5)
		for i, a := range args[5:] {
			if a != nil {
...
func (_c *MockClientInterface_RestartInstance_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.RestartInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_RestartInstance_Call {
	_c.Call.Return(run)
	return _c
}

// StartInstance provides a mock function with given fields: ctx, tenant, workspace, name, params, reqEditors
func (_m *MockClientInterface) StartInstance(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.StartInstanceParams, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.StartInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.StartInstanceParams, ...compute.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, workspace, name, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_StartInstance_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.StartInstanceParams, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_StartInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]compute.RequestEditorFn, len(args)-5)
		for i, a := range args[5:] {
			if a != nil {
...
func (_c *MockClientInterface_StartInstance_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.StartInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_StartInstance_Call {
	_c.Call.Return(run)
	return _c
}

// StopInstance provides a mock function with given fields: ctx, tenant, workspace, name, params, reqEditors
func (_m *MockClientInterface) StopInstance(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.StopInstanceParams, reqEditors ...compute.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.StopInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, name, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.StopInstanceParams, ...compute.RequestEditorFn) *http.Response); ok {
		r0 = rf(ctx, tenant, workspace, name, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*http.Response)
...
func (_c *MockClientInterface_StopInstance_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, name schema.ResourcePathParam, params *compute.StopInstanceParams, reqEditors ...compute.RequestEditorFn)) *MockClientInterface_StopInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]compute.RequestEditorFn, len(args)-5)
		for i, a := range args[5:] {
			if a != nil {
...
func (_c *MockClientInterface_StopInstance_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, schema.ResourcePathParam, *compute.StopInstanceParams, ...compute.RequestEditorFn) (*http.Response, error)) *MockClientInterface_StopInstance_Call {
	_c.Call.Return(run)
	return _c
}
