...
func (_m *MockServerInterface) GetRegion(w http.ResponseWriter, r *http.Request, name schema.ResourcePathParam) {
	_m.Called(w, r, name)
}
...
func (_c *MockServerInterface_GetRegion_Call) Run(run func(w http.ResponseWriter, r *http.Request, name schema.ResourcePathParam)) *MockServerInterface_GetRegion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(http.ResponseWriter), args[1].(*http.Request), args[2].(schema.ResourcePathParam))
	})
	return _c
}
...
func (_c *MockServerInterface_GetRegion_Call) RunAndReturn(run func(http.ResponseWriter, *http.Request, schema.ResourcePathParam)) *MockServerInterface_GetRegion_Call {
	_c.Run(run)
	return _c
}
