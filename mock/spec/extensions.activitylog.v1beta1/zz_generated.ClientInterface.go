...
func (_m *MockClientInterface) ListActivityLogs(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *activitylog.ListActivityLogsParams, reqEditors ...activitylog.RequestEditorFn) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *activitylog.ListActivityLogsParams, ...activitylog.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, tenant, workspace, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *activitylog.ListActivityLogsParams, ...activitylog.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_ListActivityLogs_Call) Run(run func(ctx context.Context, tenant schema.TenantPathParam, workspace schema.WorkspacePathParam, params *activitylog.ListActivityLogsParams, reqEditors ...activitylog.RequestEditorFn)) *MockClientInterface_ListActivityLogs_Call {
...
func (_c *MockClientInterface_ListActivityLogs_Call) RunAndReturn(run func(context.Context, schema.TenantPathParam, schema.WorkspacePathParam, *activitylog.ListActivityLogsParams, ...activitylog.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListActivityLogs_Call {
	_c.Call.Return(run)
	return _c
}
