...
func (_m *MockClientInterface) GetRegion(ctx context.Context, id string, name string, reqEditors ...regions.RequestEditorFn) (*http.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, ...regions.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, id, name, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, ...regions.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_GetRegion_Call) Run(run func(ctx context.Context, id string, name string, reqEditors ...regions.RequestEditorFn)) *MockClientInterface_GetRegion_Call {
...
func (_c *MockClientInterface_GetRegion_Call) RunAndReturn(run func(context.Context, string, string, ...regions.RequestEditorFn) (*http.Response, error)) *MockClientInterface_GetRegion_Call {
	_c.Call.Return(run)
	return _c
}

// ListRegions provides a mock function with given fields: ctx, id, params, reqEditors
func (_m *MockClientInterface) ListRegions(ctx context.Context, id string, params *regions.ListRegionsParams, reqEditors ...regions.RequestEditorFn) (*http.Response, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	...
	var r0 *http.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *regions.ListRegionsParams, ...regions.RequestEditorFn) (*http.Response, error)); ok {
		return rf(ctx, id, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *regions.ListRegionsParams, ...regions.RequestEditorFn) *http.Response); ok {
...
func (_c *MockClientInterface_ListRegions_Call) Run(run func(ctx context.Context, id string, params *regions.ListRegionsParams, reqEditors ...regions.RequestEditorFn)) *MockClientInterface_ListRegions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]regions.RequestEditorFn, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockClientInterface_ListRegions_Call) RunAndReturn(run func(context.Context, string, *regions.ListRegionsParams, ...regions.RequestEditorFn) (*http.Response, error)) *MockClientInterface_ListRegions_Call {
	_c.Call.Return(run)
	return _c
}
